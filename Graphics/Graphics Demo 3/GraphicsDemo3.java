...
public class GraphicsDemo3 extends Canvas
{
	public void paint( Graphics g )
	{
        ...
        g.drawLine(200,200,200,50); // Red line intersecting Green line
        g.drawLine(180,250,250,370); // Red line perpendicular to Magenta line
		...
		g.setFont(new Font("Georgia", Font.BOLD+Font.ITALIC, 60)); // 60-pt italic bold
		g.drawString("Leander Lions", 300, 350);

		g.setColor(Color.blue);
		g.setFont(Font.decode("Georgia-BOLDITALIC-60")); // a different way to specify the same font
